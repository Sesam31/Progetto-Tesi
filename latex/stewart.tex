...
\scalebox{2}{
\filldraw [fill=red] (9.5,3) circle (5pt);
\draw [red, line width=2pt]
	(9.5,3) to[R,color=red] (11,4.5)
	(11,4.5) to[R,color=red] (12.5,6)
	(12.5,6) -- (14,6)node[anchor=west]{\large\textbf{Analog Out}};
;
}
\end{circuitikz}
}
...
\caption{Punto $P$ ruotato di $\varphi$ gradi rispetto alla base.} \label{fig:rot}
\end{figure}
